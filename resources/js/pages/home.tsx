        ...
        <PublicLayout title="Home">
            <div className="space-y-12">
                ...
                <section className="bg-portfolio-color1 rounded-lg p-8 shadow-lg">
                    <h2 className="text-4xl mb-6 text-portfolio-text">About Me</h2>
                ...
                {/* Experience Section */}
                <section className="bg-portfolio-color1 rounded-lg p-8 shadow-lg">
                    <h2 className="text-3xl mb-6 text-portfolio-text">Relevant Experience</h2>
                    <div className="space-y-6">
                        <div className="bg-portfolio-bg rounded-md p-6 border-l-4 border-portfolio-color2">
                            <h3 className="text-xl text-portfolio-text mb-2">IT Officer</h3>
                            <p className="text-portfolio-color2 mb-2">Real Life Community Group | April 2023 - Present</p>
                            <p className="text-portfolio-text">
                        ...
                        <div className="bg-portfolio-bg rounded-md p-6 border-l-4 border-portfolio-color2">
                            <h3 className="text-xl text-portfolio-text mb-2">Administration Assistant</h3>
                            <p className="text-portfolio-color2 mb-2">South Coast Private Hospital | December 2021 - Feburary 2023</p>
                            <p className="text-portfolio-text">
                        ...
                        <div className="bg-portfolio-bg rounded-md p-6 border-l-4 border-portfolio-color2">
                            <h3 className="text-xl text-portfolio-text mb-2">Bachelor of Computer Science</h3>
                            <p className="text-portfolio-color2 mb-2">University of Wollongong | March 2019 - July 2022</p>
                            <p className="text-portfolio-text">
                        ...
                        <div className="bg-portfolio-bg rounded-md p-6 border-l-4 border-portfolio-color2">
                            <h3 className="text-xl text-portfolio-text mb-2">General Duties/Team Leader</h3>
                            <p className="text-portfolio-color2 mb-2">UOW Pulse Ltd. & Supa IGA plus Liquor Moruya | December 2015 - July 2022</p>
                            <p className="text-portfolio-text">
